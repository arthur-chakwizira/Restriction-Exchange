...
%Input: opt structure with simulation parameters
%Output:   sim_data structure with initial positions, substrate
%           coordinates, initial states
...
cell_sep = 3e-6; %cell separation, reduce for tighter packing
...
sim_data.cell_length = range(max_dim.x);
...
if show
    ...
    error("Substrate too densely packed")
